...
export default function WorkflowAutomationServices() {
  return <main className={styles.page}>
    ...
    <nav className={styles.related} aria-label="Related guides"><Link href="/guides/when-to-hire-an-automation-agency">When to hire an automation agency</Link><Link href="/compare">Comparisons and guides</Link></nav>
  </main>;
}
