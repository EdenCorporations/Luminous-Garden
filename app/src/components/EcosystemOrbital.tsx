...
const ecosystemData: TimelineItem[] = [
  ...
  },
  {
    ...
    title: "BUILD",
    date: "Phase 02",
    content: "Graft new logic onto existing infrastructure. We construct scalable, AI-driven systems that integrate seamlessly with your operations — any industry, any scale.",
  ...
  },
  {
    ...
    title: "SECURE",
    date: "Phase 04",
    content: "Protect the harvest with adaptive biometric shields. Complete data sovereignty and regulatory compliance with zero-trust architecture.",
    category: "Protection",
    icon: Shield,
    relatedIds: [1, 3],
    status: "pending",
